...
% Set up some values.
\completetitle{Framework for Probabilistic Analysis of Programs and Linking to Scientific Literature}
...
{Saumya Debray}		% 2nd committee member
{Associate Professor}
...
\include{mainmatter/grounding}
\include{mainmatter/comparison}
\include{mainmatter/analysis}
\include{mainmatter/summarization}
