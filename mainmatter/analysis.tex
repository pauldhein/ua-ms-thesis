...
The greatest benefit domain scientists receive from modeling is being able to analyze and compare the competing models that seek to explain the system of observable variables they are studying.
UMAF provides domain scientists with the ability to translate the source code models they are interested in studying into a dataflow representation, GrFN, that links source code variables across models to their corresponding real-world variables.
