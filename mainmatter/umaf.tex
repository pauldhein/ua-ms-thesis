...
Assignment statements an AST represent that a value, either a literal value or derived from a computation involving zero or more other variables, is assigned to a target variable.
