...
The chapter on related work concludes with Section~\ref{sec:rwork_dataflow_and_extraction} that covers tangential work related to knowledge extraction from structured information and the assembly of dataflow programs.
...
\section{Knowledge Extraction and Dataflow Model Assembly \label{sec:rwork_dataflow_and_extraction}}
